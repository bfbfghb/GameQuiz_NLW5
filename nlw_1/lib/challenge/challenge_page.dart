...
class _ChallengePageState extends State<ChallengePage> {
  ...
  void nextPage()
  {
      if(controller.currentPage < widget.questions.length)
        pageController.nextPage(duration: Duration(milliseconds: 10), curve: Curves.linear);
  }
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        children:[
          ...
          ValueListenableBuilder<int>(valueListenable: controller.currentPageNotifier, builder: (context, value,_) => QuestionIndicatorWidget(currentPage: value,
                  ...
                  Expanded(
                    ...
                    onTap: () {
                      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => ResultPage(
                        ...
                        title: widget.title, length: widget.questions.length,)));
                  },
                )),
            ],
            )
