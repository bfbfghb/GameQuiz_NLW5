      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Text.rich(TextSpan(text: "Voce concluiu", style: AppTextStyles.body, children: [
          ...
          Column(
            ...
            Row(
              children: [
                Expanded(child: Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 68),
                  child: NextButtonWidget.white(label: "Voltar ao Inicio", onTap: () {Navigator.pop(context);},),
                )),
              ],
            ),
            ]
